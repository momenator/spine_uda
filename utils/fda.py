# Taken from https://github.com/YanchaoYang/FDA/blob/0df83f1c74698f152ae7ad5d49f4b7e8211b8b8b/utils/__init__.py
...
def FDA_source_to_target_np(src_img, trg_img, L=0.1):
    ...
    # return as float32
    # src_in_trg = src_in_trg.astype(np.float32)
