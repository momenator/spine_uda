...
project_name = 'plain_instancenorm'
result_path = './results'
batch_size = 20
...
# 0 for actual image, 2 for edge
IMAGE_INDEX = 0

# define network here!
net = UNet(1, 1, track_running_stats=True)
net.cuda()
...
train_scan_dataset = UnpairedDataset('../', path_a='ct_sag_kr/train', path_b=None)
...
scan_dataset_test, scan_dataset_val, _ = random_split(test_scan_dataset, 
                                                      [num_test, num_val, len(test_scan_dataset) - (num_val + num_test)])
